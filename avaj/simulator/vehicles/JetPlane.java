...
public class JetPlane extends Aircraft implements Flyable {
    ...
    public void updateConditions(){
        ...
        HashMap<String, String> messages = new HashMap<String, String>() {{
            put("SUN", "Drop the Sun visors boys it's going to be a beautiful day.");
            put("RAIN", "Rain! gotta go fast!");
            put("FOG", "flying blind??, Time to test my skills in the Fog.");
            put("SNOW", "Winter is here boys, i'm taking leave.");
        }};
