...
public class Helicopter extends Aircraft implements Flyable {
    ...
    public void updateConditions(){
        ...
        HashMap<String, String> messages = new HashMap<String, String>() {{
            put("SUN", "Who's up for some ice cream on me after the flight?");
            put("RAIN", "It's raining cats and dogs! Why me?!");
            put("FOG", "Flying blind in Fog aways gets my blood rushing.");
            put("SNOW", "I'm pretty sure anti-freeze shouldn't FREEZE!");
        }};
